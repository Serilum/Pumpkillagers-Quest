...
public class SpookyHeads {
    ...
    public static List<ItemStack> getAllPumpkinHeads() {
        ...
        for (String pumpkinHeadName : pumpkinHeadData.keySet()) {
            ...
            ItemStack headStack = HeadFunctions.getNewTexturedHead(pumpkinHeadName.replace(" Head", "").replace("_", " "), pair.getSecond(), pair.getFirst(), 1);
            headStack.set(DataComponents.ITEM_NAME, Component.literal(pumpkinHeadName));
    ...
    public static ItemStack getSpookyOrPumpkinHead(String headName, int amount) {
        ...
        ItemStack headStack = HeadFunctions.getNewTexturedHead(headName.replace(" Head", "").replace("_", " "), pair.getSecond(), pair.getFirst(), amount);
        headStack.set(DataComponents.ITEM_NAME, Component.literal(headName));
