...
public class Summon {
    ...
    public static void summonFirstWave(Level level, Villager pumpkillager, Player player) {
        ...
        swordStack.enchant(level.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getHolderOrThrow(Enchantments.VANISHING_CURSE), 1);
    ...
    public static void summonSecondWave(Level level, Villager pumpkillager, Player player) {
        ...
        bowStack.enchant(level.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getHolderOrThrow(Enchantments.VANISHING_CURSE), 1);
    ...
    public static void summonFourthWave(Level level, Villager pumpkillager, Player player) {
        ...
        axeStack.enchant(enchantmentRegistry.getHolderOrThrow(Enchantments.VANISHING_CURSE), 1);

        ItemStack crossbowStack = new ItemStack(Items.CROSSBOW, 1);
        crossbowStack.enchant(enchantmentRegistry.getHolderOrThrow(Enchantments.VANISHING_CURSE), 1);
