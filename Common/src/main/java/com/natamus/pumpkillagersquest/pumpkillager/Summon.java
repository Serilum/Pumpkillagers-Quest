...
public class Summon {
    ...
    public static void summonFirstWave(Level level, Villager pumpkillager, Player player) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            EntityFunctions.getTargetSelector(zombieVillager).removeAllGoals();
    ...
    public static void summonSecondWave(Level level, Villager pumpkillager, Player player) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            EntityFunctions.getTargetSelector(skeleton).removeAllGoals();
    ...
    public static void summonFourthWave(Level level, Villager pumpkillager, Player player) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            EntityFunctions.getTargetSelector(vindicator).removeAllGoals();
            EntityFunctions.getTargetSelector(pillager).removeAllGoals();
