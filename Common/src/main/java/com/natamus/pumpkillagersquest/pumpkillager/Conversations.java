...
public class Conversations {
    ...
    public static void startPrisonerGenerationConversation(Level level, Villager prisoner, Player targetPlayer) { // 6
        ...
        bowStack.enchant(level.registryAccess().registryOrThrow(Registries.ENCHANTMENT).getHolderOrThrow(Enchantments.POWER), 3);
    ...
    public static void postFinalPrisonerConversation(Level level, Villager prisoner, Player targetPlayer) { // 9
        ...
        rewardStack.enchant(enchantmentsRegistry.getHolderOrThrow(Enchantments.SHARPNESS), 4);
        rewardStack.enchant(enchantmentsRegistry.getHolderOrThrow(Enchantments.SWEEPING_EDGE), 3);
