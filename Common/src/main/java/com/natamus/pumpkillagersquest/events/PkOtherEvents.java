...
public class PkOtherEvents {
    public static void onTNTExplode(Level level, Entity sourceEntity, Explosion explosion) {
        ...
        if (redstonePositionsLeft.size() == 0) {
            ...
            if (player.entityTags().contains(Reference.MOD_ID + ".unleashed")) {
                if (!player.entityTags().contains(Reference.MOD_ID + ".completedquest")) {
            ...
            if (!player.entityTags().contains(Reference.MOD_ID + ".questbookgiven")) {
