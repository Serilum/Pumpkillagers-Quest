...
public class PkEntityEvents {
    public static boolean onEntityJoin(Entity entity, ServerLevel level) {
        if (entity.entityTags().contains(Reference.MOD_ID + ".removed")) {
        ...
        if (entity instanceof Pig) {
            ...
            entity.entityTags().add(Reference.MOD_ID + ".pumpkincheck");
            ...
            if (entityTags.contains(Reference.MOD_ID + ".justadded")) {
                entity.entityTags().remove(Reference.MOD_ID + ".justadded");
                return true;
            }
            entity.remove(Entity.RemovalReason.DISCARDED);
            return false;
        ...
        if (entity instanceof Villager) {
            if (Util.isPumpkillager(entity)) {
                ...
                if (!level.isClientSide()) {
                    if (entity.entityTags().contains(Reference.MOD_ID + ".finalform")) {
                        ServerLevel serverLevel = (ServerLevel)level;
                        for (Entity serverEntity : serverLevel.getAllEntities()) {
                            if (serverEntity.entityTags().contains(Reference.MOD_ID + ".summoned")) {
